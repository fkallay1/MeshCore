...
// =====================================================================
  ...
  #define APP_FLASH_START      OTA_APP_FLASH_START
#else
...
#define OTA_FS_FLASH_ADDR      0xD4000u
#define OTA_FS_FLASH_SIZE      (0xEB000u - 0xD4000u)   // 92kB (23 stránok × 4096)
#define OTA_FS_BLOCK_SIZE      128u                    // LittleFS blok = 128B
