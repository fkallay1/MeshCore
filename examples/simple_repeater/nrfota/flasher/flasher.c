...
// Kompiluje sa LEN do standalone flashera cez nrfota/tools/build_flasher.py
// (definuje -DOTA_FLASHER_BUILD). V MeshCore FW builde (kde tento súbor zoberie
// rekurzívny build_src_filter) ostáva PRÁZDNY — flasher beží mimo app flash.
#ifdef OTA_FLASHER_BUILD
 ...
 * ota_check_flasher_debug() ho prečíta.
