...
*/
// Aktívne len v OTA FW builde (-DWITH_LORA_OTA) alebo standalone flasheri
// (-DOTA_FLASHER_BUILD). V stock buildoch ostáva prázdne (--gc-sections).
#if defined(WITH_LORA_OTA) || defined(OTA_FLASHER_BUILD)
...
#endif  /* WITH_LORA_OTA || OTA_FLASHER_BUILD */
