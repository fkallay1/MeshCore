...
# konštanta, preto pre každý SoftDevice samostatný blob. Výber vo FW: OtaPatcher.cpp
...
def main():
    ...
    lines = [
        f"/* {OUT_HEADER.name} — AUTO-GENERATED by nrfota/tools/build_flasher.py",
        ...
        f" *   BOARD_FLASHER={BOARD_FLASHER} python examples/simple_repeater/nrfota/tools/build_flasher.py",
        " */",
        "#pragma once",
        "#include <stdint.h>",
        "",
