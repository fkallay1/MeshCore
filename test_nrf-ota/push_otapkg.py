#!/usr/bin/env python3
"""
push_otapkg.py — vyber viacero .otapkg.json a pošli ich do telefónu (adb push).
...
Spúšťa sa cez push_otapkg.bat (double-click), netreba zadávať cesty.
...
def pick_files(initial_dir: str) -> list[str]:
    ...
    flt = "OTA balíky\0*.otapkg.json\0JSON\0*.json\0Všetko\0*.*\0\0"
    ...
    ofn.lpstrTitle = "Vyber .otapkg.json balíky na poslanie do telefónu"
